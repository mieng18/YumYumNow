...
var foods: [Food] = [
    Food(imageName: "burger_sandwich3", foodName: "Beef Burger", price: "$20",description: "Big juicy beef burger with cheese, lettuce, tomato, onions and special sauce !",rating:"4.5"),
